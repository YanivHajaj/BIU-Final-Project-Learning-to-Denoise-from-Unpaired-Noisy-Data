...
def generate(args):
    ...
    ##~~~~~~~~~~~~~~~~~~ for my computer yaniv (dont have nvidia GPU) use my cpu
    ...
    # Model load (for example load the 50epochs.pth file and start from there)
    ...
    for index, clean255 in enumerate(imgs):
        ...
        clean_numpy = clean255/255. #all pixels between [0,1]
        if noise_type == 'gauss':
